...
let route = [
    ...
    { type: "catch", pokemon: "Wooloo", level: 3 },
    // { type: "catch", pokemon: "Skwovet", level: 6 },

    // Required route 2 fights
    ...
    // Hop 5
    // { type: "kill", pokemon: "Cramorant", level: 28, nature: "Hasty", ability: "Gulp Missile", moves: "Dive/Fury Attack/Pluck/(No Move)", Ivs: "10/10/10/10/10/10" }, // Grookey starter only
    ...
    // Some Potential Route 8 Catches
    // { type: "catch", pokemon: "Pawniard", level: 41 },
    // { type: "catch", pokemon: "Togedemaru", level: 41 },
