...
let initialRoutes = {
    "23": [{ type: "init", level: 23, curve: "Medium Fast", tradeExp: true, name: "Whimsicott", item: "Rose Incense", nature: "Modest", moves: "Moonblast/Hurricane/Energy Ball/Giga Drain", Ivs: "15/15/15/15/15/15" }],
};
