...
let initialRoutes = {
    "7": [{ type: "init", level: 7, curve: "Medium Fast", name: "Ninetales", item: "Charcoal", nature: "Hardy", ability: "Flash Fire", moves: "Flamethrower/Fire Blast/Extrasensory/Nasty Plot", Ivs: "0/0/0/0/0/0" }],
    "8": [{ type: "init", level: 8, curve: "Medium Fast", name: "Ninetales", item: "Charcoal", nature: "Hardy", ability: "Flash Fire", moves: "Flamethrower/Fire Blast/Extrasensory/Nasty Plot", Ivs: "0/0/0/0/0/0" }],
    "9": [{ type: "init", level: 9, curve: "Medium Fast", name: "Ninetales", item: "Charcoal", nature: "Hardy", ability: "Flash Fire", moves: "Flamethrower/Fire Blast/Extrasensory/Nasty Plot", Ivs: "0/0/0/0/0/0" }],
    "10": [{ type: "init", level: 10, curve: "Medium Fast", name: "Ninetales", item: "Charcoal", nature: "Hardy", ability: "Flash Fire", moves: "Flamethrower/Fire Blast/Extrasensory/Nasty Plot", Ivs: "0/0/0/0/0/0" }],
};
...
let route = [
    ...
    // Nessa's Gym
    { type: "kill", pokemon: "Tympole", level: 21, nature: "Timid", moves: "Echoed Voice/Growl/Mud Shot/Round", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Krabby", level: 20, nature: "Jolly", ability: "Hyper Cutter", moves: "Whirlpool/Harden/(No Move)/(No Move)", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Corphish", level: 20, nature: "Timid", ability: "Hyper Cutter", moves: "Whirlpool/Leer/Bubble Beam/(No Move)", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Goldeen", level: 22, nature: "Timid", ability: "Swift Swim", moves: "Water Pulse/Whirlpool/Horn Attack/Agility", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Arrokuda", level: 23, nature: "Calm", ability: "Swift Swim", moves: "Aqua Jet/Bite/Whirlpool/Fury Attack", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Drednaw", level: 24, nature: "Modest", ability: "Swift Swim", moves: "Razor Shell/Water Gun/Bite/Headbutt", Ivs: "20/20/20/20/20/20", Evs: "820/0/0/0/0/0", expShare: true },

    // Bede 2
    { type: "kill", pokemon: "Solosis", level: 21, nature: "Modest", ability: "Magic Guard", moves: "Psyshock/Psybeam/Endeavor/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Gothita", level: 22, nature: "Bold", ability: "Competitive", moves: "Psyshock/Rock Tomb/Psybeam/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Hatenna", level: 23, nature: "Modest", ability: "Anticipation", moves: "Psybeam/Disarming Voice/(No Move)/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Ponyta-Galar", level: 22, nature: "Adamant", ability: "Pastel Veil", moves: "Confusion/Fairy Wind/(No Move)/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },

    // Galar Mine 2
    { type: "kill", pokemon: "Carkol", level: 21, nature: "Serious", ability: "Steam Engine", moves: "Rapid Spin/Smack Down/Ancient Power/Flame Charge", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Linoone-Galar", level: 22, nature: "Jolly", moves: "Night Slash/Baby-Doll Eyes/Sand Attack/Lick", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Thievul", level: 21, nature: "Docile", moves: "Snarl/Nasty Plot/Tail Whip/Quick Attack", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Pancham", level: 21, nature: "Adamant", moves: "Low Sweep/Circle Throw/Work Up/Arm Thrust", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Liepard", level: 22, nature: "Hasty", moves: "Torment/Fury Swipes/Sand Attack/Growl", Ivs: "0/0/0/0/0/0", expShare: true },

    // Marnie 1
    { type: "kill", pokemon: "Croagunk", level: 24, nature: "Adamant", ability: "Dry Skin", moves: "Poison Sting/Venoshock/Revenge/Sucker Punch", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Scraggy", level: 24, nature: "Adamant", ability: "Shed Skin", moves: "Beat Up/Headbutt/Low Kick/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Morpeko", level: 26, nature: "Jolly", ability: "Hunger Switch", moves: "Bite/Quick Attack/Thunder Shock/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },

    // Kabu's Gym
    { type: "catch", pokemon: "Vulpix", level: 24, expShare: true },
    { type: "catch", pokemon: "Litwick", level: 25, expShare: true },
    { type: "catch", pokemon: "Vulpix", level: 24, expShare: true },
    { type: "kill", pokemon: "Ninetales", level: 25, nature: "Bold", ability: "Flash Fire", moves: "Will-O-Wisp/Fire Spin/Quick Attack/Ember", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Arcanine", level: 25, nature: "Timid", ability: "Intimidate", moves: "Will-O-Wisp/Flame Wheel/Bite/Agility", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Centiskorch", level: 27, nature: "Impish", ability: "Flash Fire", moves: "Flame Wheel/Coil/Bug Bite/Smokescreen", Ivs: "20/20/20/20/20/20", Evs: "840/0/0/0/0/0", expShare: true },

    // Route 6 Required Fights
    { type: "kill", pokemon: "Stunky", level: 29, ability: "Aftermath", moves: "Bite/Feint/Poison Gas/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Linoone-Galar", level: 30, nature: "Serious", moves: "Hone Claws/Take Down/Night Slash/Baby-Doll Eyes", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Liepard", level: 30, nature: "Jolly", moves: "Fake Out/Fury Swipes/Assurance/Sand Attack", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Clefairy", level: 29, nature: "Serious", moves: "Metronome/(No Move)/(No Move)/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Clefable", level: 30, nature: "Serious", moves: "Metronome/(No Move)/(No Move)/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Koffing", level: 29, nature: "Modest", ability: "Neutralizing Gas", moves: "Self-Destruct/Haze/Smokescreen/Clear Smog", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Sudowoodo", level: 31, nature: "Serious", ability: "Sturdy", moves: "Slam/Rock Slide/Sucker Punch/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true },

    // Hop 5
    { type: "kill", pokemon: "Cramorant", level: 29, nature: "Hasty", ability: "Gulp Missile", moves: "Dive/Fury Attack/Pluck/(No Move)", Ivs: "10/10/10/10/10/10", expShare: true },
    { type: "kill", pokemon: "Toxel", level: 29, nature: "Bold", ability: "Static", moves: "Tearful Look/Nuzzle/Flail/Acid", Ivs: "10/10/10/10/10/10", expShare: true },
    { type: "kill", pokemon: "Thwackey", level: 33, ability: "Overgrow", moves: "Knock Off/Razor Leaf/Screech/Round", Ivs: "15/15/15/25/25/20", expShare: true },
    { type: "kill", pokemon: "Silicobra", level: 30, nature: "Bold", ability: "Shed Skin", moves: "Glare/Dig/Brutal Swing/(No Move)", Ivs: "10/10/10/10/10/10", expShare: true },

    // Bea's Gym
    { type: "kill", pokemon: "Stufful", level: 31, nature: "Adamant", moves: "Take Down/Strength/Leer/(No Move)", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Bewear", level: 32, nature: "Modest", moves: "Brutal Swing/Strength/Take Down/Bind", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Farfetch'd-Galar", level: 32, nature: "Lonely", moves: "Detect/Brutal Swing/Rock Smash/Sand Attack", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Hitmonlee", level: 33, nature: "Modest", moves: "Double Kick/Revenge/(No Move)/(No Move)", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Hitmonchan", level: 33, nature: "Modest", moves: "Mach Punch/Bullet Punch/(No Move)/(No Move)", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Hitmontop", level: 34, nature: "Adamant", ability: "Technician", moves: "Triple Kick/Quick Attack/Counter/Revenge", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Pangoro", level: 34, nature: "Careful", ability: "Mold Breaker", moves: "Bullet Punch/Circle Throw/Night Slash/Work Up", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Sirfetch'd", level: 35, nature: "Impish", ability: "Steadfast", moves: "Detect/Swords Dance/Brutal Swing/Revenge", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Machamp", level: 35, nature: "Careful", ability: "Guts", moves: "Scary Face/Revenge/Knock Off/Strength", Ivs: "20/20/20/20/20/20", Evs: "848/0/0/0/0/0", expShare: true },
    /* Yes, Machamp is Level 36 but you only get the exp equivalent of defeating it at Lv 35 due to only
    having 3 badges at that point, which only allows you to get the exp of a pokemon up to it's Lv 35 equivalent */

    // Bede 3
    { type: "kill", pokemon: "Duosion", level: 32, nature: "Modest", ability: "Magic Guard", moves: "Light Screen/Reflect/Psyshock/Psybeam", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Hattrem", level: 35, nature: "Modest", ability: "Anticipation", moves: "Dazzling Gleam/Psybeam/(No Move)/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Gothorita", level: 32, nature: "Bold", ability: "Competitive", moves: "Fake Tears/Psybeam/Rock Tomb/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Ponyta-Galar", level: 33, nature: "Adamant", ability: "Pastel Veil", moves: "Fairy Wind/Psybeam/Agility/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },

    // Opal's Gym
    { type: "kill", pokemon: "Spritzee", level: 34, nature: "Docile", moves: "Draining Kiss/Psychic/Echoed Voice/Sweet Kiss", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Slurpuff", level: 34, nature: "Bashful", moves: "Draining Kiss/Energy Ball/Cotton Spore/Fake Tears", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Swirlix", level: 34, nature: "Bashful", moves: "Draining Kiss/Energy Ball/Cotton Spore/Fake Tears", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Aromatisse", level: 34, nature: "Docile", moves: "Draining Kiss/Psychic/Echoed Voice/Sweet Kiss", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Morgrem", level: 35, nature: "Adamant", ability: "Prankster", moves: "Fake Out/False Surrender/Flatter/Draining Kiss", Ivs: "5/5/5/5/5/5", expShare: true },
    { type: "kill", pokemon: "Gardevoir", level: 35, nature: "Timid", ability: "Synchronize", moves: "Dazzling Gleam/Mystical Fire/Charm/Reflect", Ivs: "5/5/5/5/5/5", expShare: true },
    ...
    // Gordie's Gym
    // { type: "kill", pokemon: "Boldore", level: 38, nature: "Calm", moves: "Smack Down/Rock Blast/Mud-Slap/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true }, // Gym Trainer Abigail
    { type: "kill", pokemon: "Barbaracle", level: 40, nature: "Adamant", ability: "Tough Claws", moves: "Shell Smash/Rock Tomb/Razor Shell/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Shuckle", level: 40, nature: "Quiet", ability: "Contrary", moves: "Power Split/Stone Edge/Struggle Bug/Rock Tomb", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Stonjourner", level: 41, nature: "Jolly", ability: "Power Spot", moves: "Stealth Rock/Rock Tomb/Body Slam/Wonder Room", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Coalossal", level: 42, nature: "Adamant", ability: "Steam Engine", moves: "Tar Shot/Stealth Rock/Heat Crash/Rock Tomb", Ivs: "20/20/20/20/20/20", Evs: "1004/0/0/0/0/0", expShare: true },
    ...
    // Route 10 Trainers
    { type: "kill", pokemon: "Gardevoir", level: 45, nature: "Modest", ability: "Synchronize", moves: "Dazzling Gleam/Draining Kiss/Calm Mind/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true },
    // { type: "kill", pokemon: "Corviknight", level: 45, nature: "Bold", ability: "Unnerve", moves: "Swagger/Drill Peck/Steel Wing/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true }, // Cabbie Geoffrey
    // { type: "kill", pokemon: "Flygon", level: 46, ability: "Levitate", moves: "Earthquake/Dragon Tail/Earth Power/(No Move)", Ivs: "0/0/0/0/0/0", expShare: true }, // Cabbie Geoffrey
    { type: "kill", pokemon: "Pelipper", level: 46, nature: "Calm" ,ability: "Drizzle", moves: "Tailwind/Roost/Water Pulse/Air Slash", Ivs: "0/0/0/0/0/0", expShare: true }, // Postman Harper
    { type: "kill", pokemon: "Noctowl", level: 46, nature: "Bold", moves: "Hypnosis/Moonblast/Roost/Air Slash", Ivs: "0/0/0/0/0/0", expShare: true }, // Postman Harper
    { type: "kill", pokemon: "Gigalith", level: 46, nature: "Adamant", ability: "Sand Stream", moves: "Iron Defense/Rock Slide/Rock Blast/Stealth Rock", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Rhydon", level: 46, nature: "Brave", moves: "Take Down/Bulldoze/Horn Drill/Stone Edge", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Darmanitan-Galar", level: 46, nature: "Jolly", ability: "Gorilla Tactics", moves: "Icicle Crash/Headbutt/Taunt/Uproar", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Falinks", level: 46, nature: "Jolly", moves: "No Retreat/First Impression/Close Combat/Headbutt", Ivs: "0/0/0/0/0/0", expShare: true },
    { type: "kill", pokemon: "Grapploct", level: 46, nature: "Calm", moves: "Superpower/Octolock/Reversal/Bulk Up", Ivs: "0/0/0/0/0/0", expShare: true },
    ...
    // { type: "ev-gain", spd: 90 },
    // { type: "ev-gain", spd: 70 },
    // { type: "ev-gain", spAtk: 70 },
    // { type: "ev-gain", spAtk: 50 },
    ...
    // Bea Final
    { type: "kill", pokemon: "Hawlucha", level: 52, nature: "Adamant", ability: "Limber", moves: "Flying Press/High Jump Kick/Bounce/(No Move)", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Grapploct", level: 52, nature: "Bold", ability: "Limber", moves: "Octolock/Submission/Bind/Mega Punch", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Sirfetch'd", level: 53, nature: "Impish", ability: "Steadfast", moves: "Leaf Blade/Slam/Brick Break/Brutal Swing", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Falinks", level: 53, nature: "Bold", ability: "Battle Armor", moves: "No Retreat/Bulk Up/Close Combat/Rock Tomb", Ivs: "15/15/15/15/15/15", expShare: true },
    { type: "kill", pokemon: "Machamp", level: 54, nature: "Careful", ability: "Guts", moves: "Cross Chop/Revenge/Fire Punch/Strength", Ivs: "20/20/20/20/20/20", Evs: "892/0/0/0/0/0", expShare: true },
