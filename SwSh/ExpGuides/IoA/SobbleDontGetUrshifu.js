...
let initialRoutes = {
    "5": [{ type: "init", level: 5, curve: "Medium Slow", name: "Sobble", nature: "Hardy", ability: "Torrent", evolution1: 16, evolution1Name: "Drizzile", moves: "Tackle/Growl/(No Move)/(No Move)", Ivs: "0/0/0/18/0/0" }],
};
...
let route = [
    ...
    { type: "change-moves", moves: "Tackle/Growl/Water Gun/Water Pulse" },
    { type: "catch", pokemon: "Slowpoke-Galar", level: 12 },
    ...
    { type: "item-equip", item: "Lucky Egg" },
    ...
    { type: "change-moves", moves: "Muddy Water/Growl/Water Gun/Water Pulse" },

    // Slowpoke Hunt
    { type: "kill", pokemon: "Slowpoke-Galar", level: 17 },
    { type: "kill", pokemon: "Slowpoke-Galar", level: 17 },
    { type: "evolve" },
    { type: "kill", pokemon: "Slowpoke-Galar", level: 17 },
    ...
    // Klara 3, As all Pokemon are above Level 20 and you don't have a gym badge, you only gain experience equivalent for defeating a level 20, similar to Onix earlier
