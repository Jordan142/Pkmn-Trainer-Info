...
let initialRoutes = {
    "5": [{ type: "init", level: 5, curve: "Medium Slow", name: "Sobble", nature: "Hardy", ability: "Torrent", evolution1: 16, evolution1Name: "Drizzile", evolution2: 35, evolution2Name: "Inteleon", moves: "Tackle/Growl/(No Move)/(No Move)", Ivs: "0/0/0/20/0/10" }],
};
...
let route = [
    ...
    { type: "catch", pokemon: "Onix", level: 20 },
    { type: "change-moves", moves: "Tackle/Swift/Water Gun/Water Pulse" },
    ...
    { type: "rare-candy" },
    { type: "rare-candy" },
    { type: "change-moves", moves: "Water Pledge/Swift/Rain Dance/Water Pulse" },
    ...
    { type: "catch", pokemon: "Pawniard", level: 39 },
    ...
    { type: "change-moves", moves: "Water Pledge/Icy Wind/Rain Dance/Water Pulse" },
    ...
    { type: "change-moves", moves: "Water Pledge/Icy Wind/Rain Dance/Hydro Cannon" },
